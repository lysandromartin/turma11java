...
public class alunoxnota {
	...
	public static void main(String[] args) {
		...
		//String nomeAlunos [] = {"Herick","Zaine","Lysandro","Gabriel"};
		int codigoAlunos [] = new int [nomeAlunos.length];
		...
		do {
			...
			System.out.println("Digite o numero do alunx: ");
			codigoAluno = leia.nextInt();
			codigoAluno = codigoAluno - 1;
			System.out.println("Alunx "+nomeAlunos[codigoAluno]);
			System.out.println("Qual nota você quer atribuir a este alunx?");
